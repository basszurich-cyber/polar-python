...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.benefit_grants.get(security=spaire_sdk.CustomerPortalBenefitGrantsGetSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), id="<value>")
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.benefit_grants.update(security=spaire_sdk.CustomerPortalBenefitGrantsUpdateSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
