...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.customer_meters.list(security=spaire_sdk.CustomerPortalCustomerMetersListSecurity(
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.customer_meters.get(security=spaire_sdk.CustomerPortalCustomerMetersGetSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), id="<value>")
