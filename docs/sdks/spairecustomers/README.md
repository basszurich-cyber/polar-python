...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.customers.get(security=spaire_sdk.CustomerPortalCustomersGetSecurity(
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.customers.update(security=spaire_sdk.CustomerPortalCustomersUpdateSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), request={
        "billing_address": {
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.customers.list_payment_methods(security=spaire_sdk.CustomerPortalCustomersListPaymentMethodsSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), page=1, limit=10)
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.customers.add_payment_method(security=spaire_sdk.CustomerPortalCustomersAddPaymentMethodSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), request={
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.customers.confirm_payment_method(security=spaire_sdk.CustomerPortalCustomersConfirmPaymentMethodSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), request={
        "setup_intent_id": "<id>",
        "set_default": True,
...
with Spaire() as spaire:
    ...
    spaire.customer_portal.customers.delete_payment_method(security=spaire_sdk.CustomerPortalCustomersDeletePaymentMethodSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), id="<id>")
