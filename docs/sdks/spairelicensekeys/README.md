...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.license_keys.list(security=spaire_sdk.CustomerPortalLicenseKeysListSecurity(
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.license_keys.get(security=spaire_sdk.CustomerPortalLicenseKeysGetSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), id="<value>")
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.license_keys.validate(request={
        "key": "<key>",
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.license_keys.activate(request={
        "key": "<key>",
        "organization_id": "<value>",
        "label": "<value>",
    })
...
with Spaire() as spaire:
    ...
    spaire.customer_portal.license_keys.deactivate(request={
        "key": "<key>",
        "organization_id": "<value>",
        "activation_id": "<value>",
    })
