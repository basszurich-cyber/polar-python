...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.orders.list(security=spaire_sdk.CustomerPortalOrdersListSecurity(
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.orders.get(security=spaire_sdk.CustomerPortalOrdersGetSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), id="<value>")
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.orders.update(security=spaire_sdk.CustomerPortalOrdersUpdateSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.orders.generate_invoice(security=spaire_sdk.CustomerPortalOrdersGenerateInvoiceSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), id="<value>")
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.orders.invoice(security=spaire_sdk.CustomerPortalOrdersInvoiceSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), id="<value>")
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.orders.get_payment_status(security=spaire_sdk.CustomerPortalOrdersGetPaymentStatusSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), id="<value>")
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.orders.confirm_retry_payment(security=spaire_sdk.CustomerPortalOrdersConfirmRetryPaymentSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
