...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.subscriptions.list(security=spaire_sdk.CustomerPortalSubscriptionsListSecurity(
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.subscriptions.get(security=spaire_sdk.CustomerPortalSubscriptionsGetSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), id="<value>")
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.subscriptions.update(security=spaire_sdk.CustomerPortalSubscriptionsUpdateSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
...
with Spaire() as spaire:
    ...
    res = spaire.customer_portal.subscriptions.cancel(security=spaire_sdk.CustomerPortalSubscriptionsCancelSecurity(
        customer_session="<YOUR_BEARER_TOKEN_HERE>",
    ), id="<value>")
