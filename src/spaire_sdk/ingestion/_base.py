...
if TYPE_CHECKING:
    from spaire_sdk import EventMetadataInput, EventsModelTypedDict

    from .strategies._base import S

logger = logging.getLogger("spaire_sdk.ingestion")


class Ingestion:
    """
    Event ingestion client for Spaire.

    This class handles the ingestion of events into the Spaire API without blocking
    ...
    def __init__(
        ...
        *,
        ...
        self._client = self._stack.enter_context(
            Spaire(access_token, server, server_url)
        )
