...
class BalanceDisputeReversalEventTypedDict(TypedDict):
    r"""An event created by Spaire when a dispute is won and funds are reinstated."""
    ...
    r"""ID of the customer in your Spaire organization associated with the event."""
    ...
    r"""The source of the event. `system` events are created by Spaire. `user` events are the one you create through our ingestion API."""
