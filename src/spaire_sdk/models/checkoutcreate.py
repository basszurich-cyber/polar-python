...
from spaire_sdk.types import BaseModel, Nullable, OptionalNullable, UNSET, UNSET_SENTINEL
from spaire_sdk.utils import get_discriminator
...
class CheckoutCreateTypedDict(TypedDict):
    ...
    * A boolean
    ...
    r"""ID of the customer in your system. If a matching customer exists on Spaire, the resulting order will be linked to this customer. Otherwise, a new customer will be created with this external ID set."""
    ...
    * A boolean
    ...
    r"""If you plan to embed the checkout session, set this to the Origin of the embedding page. It'll allow the Spaire iframe to communicate with the parent page."""
